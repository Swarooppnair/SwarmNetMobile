...
import com.bitchat.android.features.ai.SurvivalAssistantScreen
...
fun MainScreen(chatViewModel: com.bitchat.android.ui.ChatViewModel) {
    ...
    val navItems = listOf(
        ...
        Triple(Icons.Filled.Map, "Map", 1),
        Triple(Icons.Filled.Shield, "Survival", 2),
                        ...
                        navItems.forEach { (icon, label, index) ->
                            NavigationBarItem(
                                ...
                                colors = androidx.compose.material3.NavigationBarItemDefaults.colors(
                                    indicatorColor = Color(0xFFFF3B30).copy(alpha = 0.12f),
                                    selectedIconColor = Color(0xFFFF3B30),
                                    selectedTextColor = Color(0xFFFF3B30),
        ...
        androidx.compose.foundation.layout.Box(
            ...
            androidx.compose.animation.AnimatedContent(
                ...
                when (tab) {
                    ...
                    1 -> com.bitchat.android.mapfeature.MapFeatureScreen(chatViewModel = chatViewModel)
                    2 -> com.bitchat.android.features.ai.SurvivalAssistantScreen()
                    3 -> com.bitchat.android.features.settings.SettingsScreen(chatViewModel = chatViewModel)
                }
            }
        }
    }
